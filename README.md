...
[truffle-config.js](
https://github.com/cross-chain/SwapAssetContract/blob/master/truffle-config.js)
 ...
 like our example: [BtcSwapAsset.sol](https://github.com/cross-chain/SwapAssetContract/blob/master/contracts/BtcSwapAsset.sol).

### 3. Add migrations to deploy contract

Add an `js` file to depoly contract in `migrations` directory.

like our example: [2_deploy_contracts.js](https://github.com/cross-chain/SwapAssetContract/blob/master/migrations/2_deploy_contracts.js).
